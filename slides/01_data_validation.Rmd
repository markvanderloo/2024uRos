...
```{eval=FALSE}
git clone https://github.com/markvanderloo/2024uRos
```

- Create an RStudio project in `2024uRos`
- Open the file `01_validate.R`
...
- $0.9<\textsf{mean}(Profit_{2018})/\textsf{mean}(Profit_{2017}) <1.1$: $smss$, level 1
